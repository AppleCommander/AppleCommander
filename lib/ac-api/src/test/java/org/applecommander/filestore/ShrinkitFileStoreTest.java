...
import org.applecommander.archive.shrinkit.ShrinkitFileStore;
...
public class ShrinkitFileStoreTest {
    @Test
    public void test() {
        final String fullPath = "src/test/resources/disks/tipdisk1.sdk";
        ...
        if (fileStore instanceof ShrinkitFileStore shkFileStore) {
            Directory directory = shkFileStore.getRootDirectory();
            ...
            fail("Expecting a ShrinkitFileStore!");
        }
    }
}
